...
const login = () => {
    ...
    async function signInWithEmail(e){
       ...
       <h1 className="font-bold text-2xl">Welcome Back to login :)</h1>
       <form className="flex flex-col bg-white rounded shadow-lg p-12 mt-12" action="">
           ...
           className="flex items-center justify-center h-12 px-6 w-64 bg-blue-600 mt-8 rounded font-semibold text-sm text-blue-100 hover:bg-blue-700">Log in</button>
